    ...
    return (
        <div className="max-w-[1320px] mx-auto 2xl:px-0 px-5 relative">
            <div className="flex justify-between items-center">
                <h4 className="font-medium text-[54px] text-[#201F1B]">Cuisine Experience:</h4>
                <button className="btn relative uppercase but tra w-[192px] h-[50px] rounded-full hover:text-white bg-transparent border-[#E9E9E8] font font-semibold text-[15px] hover:bg-[#FE6A3A] text-[#201F1B]">
