    ...
    return (
        <div className="bg-[url(https://i.imgur.com/9RlwUY8.png)] bg-cover bg-no-repeat py-24">
            ...
            <form className="w-[969px] mx-auto mt-14 grid grid-cols-3 gap-6">
                ...
                <select className="px-4 select focus:outline-[#201F1B] w-[303px] h-[56px] rounded-[8px] text-[#201F1B] placeholder:text-[#201F1B] text-[19px] border border-[#201F1B] bg-white" defaultValue={'Person'}>
