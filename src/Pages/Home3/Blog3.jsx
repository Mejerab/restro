    ...
    return (
        <div className="max-w-[1320px] mx-auto px-0">
            <div className="text-center">
                <PointHook2 head={'blog post'} text={'Our Latest Blog And Articles.'} center />
            </div>
            <div className="flex justify-between mt-14">
                <div data-aos='fade-right' className="space-y-9">
                    <div className="border border-[#E9E9E8] rounded-lg w-[416px] h-[300px] pl-8">
                        ...
                        <h4 className="text-[25px] leading-[35px] mt-4 text-[#201F1B] font-medium">Must-Try Dishes That Will Leave You Craving Restaurant.</h4>
                ...
                <div data-aos='fade-up' className="border border-[#E9E9E8] rounded-lg w-[416px] h-[636px] pl-8 pt-7">
                    <img src="https://i.imgur.com/sJpJZks.png" alt="" />
                ...
                <div data-aos='fade-left' className="space-y-9">
                    <div className="border border-[#E9E9E8] rounded-lg w-[416px] h-[300px] pl-8">
                        <div className="flex gap-x-6 mt-6">
                            <p className="text-[13px] font-medium text-[#63625F] uppercase">By: <span className="text-[#0E7258]">roland toski</span></p>
                            <p className="text-[13px] font-medium text-[#63625F] uppercase">Date: <span className="text-[#FE6A3A]"> 02 november 2024</span></p>
