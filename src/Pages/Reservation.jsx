                ...
                <div className="bg-[url(https://i.imgur.com/zj8G0G8.png)] bg-no-repeat bg-cover w-[778px] h-fit rounded-xl p-20">
                    ...
                    <form onSubmit={handleSubmit} className="mt-9 space-y-7">
                        <div className="flex justify-between gap-x-7">
                            <input data-aos='fade-right' type="text" className="input w-full h-[56px] text-[19px] text-[#201F1B] placeholder:text-[#201F1B] border border-[#201F1B] rounded-[8px]" placeholder="Full Name:" />
                            <input data-aos='fade-left' type="email" className="input w-full h-[56px] text-[19px] text-[#201F1B] placeholder:text-[#201F1B] border border-[#201F1B] rounded-[8px]" placeholder="Email Address:" />
                        </div>
                        <div className="flex justify-between gap-x-6">
                            <input data-aos='fade-right' type="tel" className="input w-full h-[56px] text-[19px] text-[#201F1B] placeholder:text-[#201F1B] border border-[#201F1B] rounded-[8px]" placeholder="Phone:" />
                            <select name="select" data-aos='fade-left' className="px-4 select focus:outline-[#201F1B] w-full h-[56px] rounded-[8px] text-[#201F1B] placeholder:text-[#201F1B] text-[19px] border border-[#201F1B] bg-white" defaultValue={'Person'}>
                        ...
                        <div className="flex justify-between gap-x-6">
                            <input data-aos='fade-right' type="date" className="input w-full h-[56px] text-[19px] text-[#201F1B] placeholder:text-[#201F1B] border border-[#201F1B] rounded-[8px]" />
                            <input data-aos='fade-left' type="time" className="input w-full h-[56px] text-[19px] text-[#201F1B] placeholder:text-[#201F1B] border border-[#201F1B] rounded-[8px]" />
                        </div>
